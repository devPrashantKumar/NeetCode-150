 ...
 * Space Compexity O(n)
 */
class SolutionPrefixSuffixApproachTest {
...
public class PrefixSuffixApproachTest {
    public static void main(String[] args) {
        SolutionPrefixSuffixApproachTest solution = new SolutionPrefixSuffixApproachTest();
        int[] nums1 = { 1, 2, 4, 6 };
        int[] nums2 = { -1, 0, 1, 2, 3 };
        System.out.println("---------------------------------------------------");
